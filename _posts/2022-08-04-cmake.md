...
### 配置过程学习自：[手把手教会VSCode的C++环境搭建，多文件编译，Cmake，json调试配置（ Windows篇）](https://www.bilibili.com/video/BV13K411M78v?p=2&vd_source=13b3aed8b3f815cd63915fb2c4b8a63a)
...
在这个简单的多文件编译链接的例子里，看看如何完成基本配置  
共三个文件 main.c fun.c fun.h
```
//main.c
#include <stdio.h>
#include "fun.h"
